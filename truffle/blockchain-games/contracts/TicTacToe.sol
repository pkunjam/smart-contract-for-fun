...
contract TicTacToe {
    ...
    constructor () public payable {
        require(msg.value >= 1 ether, "in TicTacToe:constructor(). Value is less than 1 ether.");
    ...
    function joinGame() public payable {
        require(msg.value >=  1 ether, "in TicTacToe:joinGame(). Value is less than 1 ether.");
